<div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @enderror
                                    @if ($image)
                                        <img class="mt-2" src="{{ $image->temporaryUrl() }}" height="100" width="100">
                                    @endif
    ...
    {{-- @push('scripts')
        <script src="{{ URL::asset('assets/backend/plugins/ckeditor/ckeditor.js') }}"></script>
        <script>
            Livewire.on('providerUpdated', () => {

                CKEDITOR.replace('editor1', {
                    height: 200,
                    filebrowserUploadUrl: "{{ route('ck_image_upload', ['_token' => csrf_token()]) }}",
